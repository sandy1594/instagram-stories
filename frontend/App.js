  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <TouchableWithoutFeedback onPress={() => setModalVisible(true)}>
        ...
        <Text style={{textAlign:"center"}}>Welcome to Instagram</Text>
      <Text style={{ fontWeight: "bold", color: "#D62976" ,
      textAlign:"center"}}>
        Instagram Stories feature on React-Native
      </Text>
      <Image style = {{ width: 320, height: 330,
        justifyContent: 'center',
        alignItems: 'center'}}
         source={{
        uri:"https://qph.fs.quoracdn.net/main-qimg-8cb900ea3908cfc4abf6851693305a13.webp",
      }}/>
    </View>
  );
}
